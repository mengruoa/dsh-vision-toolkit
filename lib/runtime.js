        ...
        return this.runOperation('vision_toolkit_health', options, async (operation) => {
            ...
            if (testModel) {
                if (resolvedCredential === undefined) {
                    ...
                    try {
                        const result = await this.runUpstream('glance', [VISION_MODEL_TEST_IMAGE, '-q', VISION_MODEL_TEST_PROMPT], operation, this.providerEnv(this.primaryProvider, resolvedCredential));
