...
import { assertSecureSharedStorageBase, assertSecureWorkspaceStorage, isWithin } from "./paths.js";
...
async function assertManagedArtifactRoot(root) {
    const storageRoot = dirname(root);
    if (basename(storageRoot) === '.dsh-vision-toolkit')
        return;
