...
export class VisionToolkitWebBackend {
    ...
    async saveCredential(request) {
        ...
        if (provider === undefined) {
            throw new CredentialReferenceConflictError(`credential reference "${String(request.ref)}" does not match any configured vision provider; reload Settings and try again`);
        }
        if (isBuiltInFreeVisionProvider(provider)) {
