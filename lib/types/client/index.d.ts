...
declare const en: {
    ...
    readonly t1: "t1 — single-request hedge (s)";
    readonly t1Hint: "When a single request exceeds t1, keep it running and start the next model in parallel.";
    readonly t2: "t2 — cumulative cutoff (s)";
    readonly t2Hint: "Terminate the model once its accumulated request time reaches t2.";
    readonly hardTimeout: "Global hard timeout (s)";
    readonly hardTimeoutHint: "Wall-clock ceiling for one tool call; on timeout every request is cancelled.";
    readonly sessionConcurrency: "Per-session max concurrency";
    readonly sessionConcurrencyHint: "Maximum concurrent vision calls in one session; excess is rejected immediately.";
    readonly minAvailable: "Minimum available time (s)";
    readonly minAvailableHint: "No new request is issued once the remaining budget drops below this value.";
    readonly maxBytes: "Maximum image bytes";
    readonly maxPixels: "Maximum image pixels";
    readonly concurrency: "Concurrency (per model)";
